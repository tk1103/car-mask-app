  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="max-w-2xl mx-auto px-4 py-8 pb-16">
        <p className="text-xs text-amber-200/90 mb-6 leading-relaxed border border-amber-500/30 rounded-lg px-3 py-2 bg-amber-500/10">
          本ページは一般的事項を定めたものです。最終的な表現は弁護士等の専門家の確認を推奨します。会社名・連絡先は貴社情報に差し替えてください。
        </p>
        <header className="mb-8">
          ...
          <h1 className="text-2xl font-light text-white mt-4 tracking-wide">Carkus 利用規約</h1>
          <p className="text-zinc-500 text-sm mt-2">最終更新日: 2026年4月29日</p>
        </header>

        <div className="space-y-8 text-sm font-light text-zinc-300 leading-relaxed">
          <section>
            <h2 className="text-base font-medium text-white mb-2">第1条（適用）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第2条（本サービスの内容）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第3条（第三者のAIサービスの利用）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第4条（利用者提供情報と権利表示）</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第5条（禁止事項）</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第6条（有料・無料等）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第7条（保証の否認）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第8条（損害賠償の制限）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第9条（本サービスの変更・停止）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第10条（規約の変更）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第11条（分離可能条項・準拠法・合意管轄）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-white mb-2">第12条（お問い合わせ）</h2>
            <p>
